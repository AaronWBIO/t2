<script>
	$(document).ready(function() {
		...
		$('#listDiv').on('click', '.viewCompany', function(event) {
			...
			popUp('<?= base_url(); ?>/Empresas/companies/edtForm/' + companies_id);
