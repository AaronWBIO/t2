...
// if(!empty($fleets) && $fleets[0]['rev_year'] != date('Y')){
// 	$validation = false;
// }
...
<div style="margin-top: 20px;">
	...
	<table class="table">
		<thead>
			<tr style="background-color:#EEE; font-weight: bold; text-align: center; font-size: .9em;">
...
<!-- 				<tr>
 ...
 -->			<?php } ?>
	...
	<div style="margin-top:30px;">
		...
		<table class="table">
			<thead style="background-color:#EEE; font-weight: bold; text-align: center; font-size: .9em;">
				<tr >
					<th rowspan="2">Nombre de la flota</th>
					<th colspan="5" style="border-left: solid 1px;">Toneladas totales</th>
					<th colspan="5" style="border-left: solid 1px;">Gramos por kilómetro</th>
					<th colspan="5" style="border-left: solid 1px;">Gramos por tonelada - kilómetro</th>
				</tr>
				<tr>
					<th style="border-left: solid 1px;">CO<sub>2</sub></th>
			...
			<tbody>
				...
				?>
					<tr>
						<td><?= "$f[cname] - $f[fname]"; ?></td>

						<td style="border-left: solid 1px;"><?= number_format($f['CO2']/1000000,2); ?></td>
						...
						<td style="border-left: solid 1px;"><?= number_format($f['CO2GKM'],2); ?></td>
						...
						<td style="border-left: solid 1px;"><?= number_format($f['CO2GTonKM'],2); ?></td>
		...
		<table class="table">
			...
			<tbody>
				<tr>
					...
					<td style="border-left: solid 1px;"><?= number_format($sum_company['CO2']/1000000,2); ?></td>
					...
					<td style="border-left: solid 1px;"><?= number_format($sum_company['CO2GKM'],2); ?></td>
					...
					<td style="border-left: solid 1px;"><?= number_format($sum_company['CO2GTonKM'],2); ?></td>
...
<div style="text-align:right;">
	<?php if ($validation && empty( session()->get('isLoggedInAdmin') ) ){ ?>
